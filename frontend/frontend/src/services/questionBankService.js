...
export const deleteQuestionBank = (id, reason) =>
  api.delete(`/question-banks/${id}/`, reason ? { data: { reason } } : undefined).then((r) => r.data)
...
export const deleteBankQuestion = (id, reason) =>
  api.delete(`/question-banks/questions/${id}/`, reason ? { data: { reason } } : undefined).then((r) => r.data)
