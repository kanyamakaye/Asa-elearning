...
router.register('exams/questions', views.ExamQuestionViewSet, basename='exam-question')
router.register('exams/attempts', views.ExamAttemptViewSet, basename='exam-attempt')
